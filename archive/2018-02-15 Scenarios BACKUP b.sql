...
alter table p1533_cambridge_scenarios.parcel_new_development
	add column landarea_alwaysresi int default 0,
	add column landarea_contingent int default 0,
	add column frontage_alwaysresi int default 0,
	add column frontage_contingent int default 0,
	add column built_resi_alwaysresi int default 0,
	add column built_resi_contingent int default 0,
	add column built_nonresi_alwaysresi int default 0,
	add column built_nonresi_contingent int default 0,
	add column built_units_alwaysresi int default 0,
	add column built_units_contingent int default 0,
	add column built_retail_alwaysresi int default 0,
	add column built_retail_contingent int default 0,
	add column built_comm_alwaysresi int default 0,
	add column built_comm_contingent int default 0,
	add column built_lab_alwaysresi int default 0,
	add column built_lab_contingent int default 0,
	add column built_insti_alwaysresi int default 0,
	add column built_insti_contingent int default 0,
	add column built_indus_alwaysresi int default 0,
	add column built_indus_contingent int default 0,
	add column built_other_alwaysresi int default 0,
	add column built_other_contingent int default 0,
	add column allowed_gfa_resi_alwaysresi int default 0,
...
--parcel conditions
update p1533_cambridge_scenarios.parcel_new_development
	set	landarea_alwaysresi = landarea_new 
...
update p1533_cambridge_scenarios.parcel_new_development
	set	frontage_alwaysresi = frontage_ft
	where scenario_use = 'resi';

update p1533_cambridge_scenarios.parcel_new_development
	set	frontage_contingent = frontage_ft 
	where scenario_use = 'nonresi';
...
--built conditions
update p1533_cambridge_scenarios.parcel_new_development
	set	built_resi_alwaysresi = built_resi 
	where scenario_use = 'resi';
...
update p1533_cambridge_scenarios.parcel_new_development
	set	built_nonresi_alwaysresi = built_gfa - built_resi 
	where scenario_use = 'resi';
...
update p1533_cambridge_scenarios.parcel_new_development
	set	built_units_alwaysresi = built_units
	where scenario_use = 'resi';
...
update p1533_cambridge_scenarios.parcel_new_development
	set	built_retail_alwaysresi = built_retail
	where scenario_use = 'resi';
...
update p1533_cambridge_scenarios.parcel_new_development
	set	built_comm_alwaysresi = built_comm
	where scenario_use = 'resi';

update p1533_cambridge_scenarios.parcel_new_development
	set	built_comm_contingent = built_comm 
	where scenario_use = 'nonresi';

update p1533_cambridge_scenarios.parcel_new_development
	set	built_lab_alwaysresi = built_lab
	where scenario_use = 'resi';

update p1533_cambridge_scenarios.parcel_new_development
	set	built_lab_contingent = built_lab 
	where scenario_use = 'nonresi';


update p1533_cambridge_scenarios.parcel_new_development
	set	built_insti_alwaysresi = built_insti
	where scenario_use = 'resi';

update p1533_cambridge_scenarios.parcel_new_development
	set	built_insti_contingent = built_insti 
	where scenario_use = 'nonresi';


update p1533_cambridge_scenarios.parcel_new_development
	set	built_indus_alwaysresi = built_indus
	where scenario_use = 'resi';

update p1533_cambridge_scenarios.parcel_new_development
	set	built_indus_contingent = built_indus 
	where scenario_use = 'nonresi';

update p1533_cambridge_scenarios.parcel_new_development
	set	built_other_alwaysresi = built_other
	where scenario_use = 'resi';

update p1533_cambridge_scenarios.parcel_new_development
	set	built_other_contingent = built_other 
	where scenario_use = 'nonresi';

update p1533_cambridge_scenarios.parcel_new_development
	set allowed_gfa_resi_alwaysresi = allowed_gfa_resi 
	where scenario_use = 'resi';
...
create table p1533_cambridge_scenarios.baseline_calcs_by_area as
	select
		dist_type,
		study_area,
		sum(landarea_alwaysresi) landarea_alwaysresi,
		sum(landarea_contingent) landarea_contingent,
		sum(frontage_alwaysresi) frontage_alwaysresi,
		sum(frontage_contingent) frontage_contingent,

		sum(built_gfa) built_gfa,
		sum(built_resi_alwaysresi) built_resi_alwaysresi,
		sum(built_nonresi_alwaysresi) built_nonresi_alwaysresi,
		sum(built_resi_contingent) built_resi_contingent,
		sum(built_nonresi_contingent) built_nonresi_contingent,
		sum(built_units_alwaysresi) built_units_alwaysresi,
		sum(built_units_contingent) built_units_contingent,
		sum(built_retail_alwaysresi) built_retail_alwaysresi,
		sum(built_retail_contingent) built_retail_contingent,
		sum(built_comm_alwaysresi) built_comm_alwaysresi,
		sum(built_comm_contingent) built_comm_contingent,
		sum(built_lab_alwaysresi) built_lab_alwaysresi,
		sum(built_lab_contingent) built_lab_contingent,
		sum(built_insti_alwaysresi) built_insti_alwaysresi,
		sum(built_insti_contingent) built_insti_contingent,
		sum(built_indus_alwaysresi) built_indus_alwaysresi,
		sum(built_indus_contingent) built_indus_contingent,
		sum(built_other_alwaysresi) built_other_alwaysresi,
		sum(built_other_contingent) built_other_contingent,


		sum(allowed_gfa_choice) allowed_gfa_choice,
		sum(allowed_gfa_resi_alwaysresi) allowed_gfa_resi_alwaysresi,
